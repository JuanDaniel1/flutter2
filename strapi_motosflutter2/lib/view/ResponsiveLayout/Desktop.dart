                    ...
                    child: GridTile(
                      child: GestureDetector(
                          child:Card(
                            ...
                            child:Column(
                              children: [
                                Text(snapshot.data![index].marca,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                                Text(snapshot.data![index].modelo,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
