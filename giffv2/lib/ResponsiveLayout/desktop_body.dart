...
//Crea una funcion privada _getGifs() del futuro de la lista de pbjetos Gif
  Future <List<Gif>> _getGifs() async {
    final stringUri = "https://api.giphy.com/v1/gifs/trending?api_key=L6OtgbhLMvBXVe217RxOyhfcZ6dMok2F&limit=$selected&rating=$range";
    final response = await http.get(Uri.parse(stringUri)); //Convierte el texto a url
    List<Gif> gifs = [];

    //Espera la respuesta del servidor y si es 200 entonces pasa la informacion a lenguaje espanol y convierte esta informacion en formato JSON
